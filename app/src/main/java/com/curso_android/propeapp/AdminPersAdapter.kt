...
class AdminPersAdapter(private var personal: List<AdminPers> = emptyList(), private val alSeleccionarPersonal:(String) -> Unit)
    : RecyclerView.Adapter<AdminPersAdapter.AdminPersViewHolder>() {
